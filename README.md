...
<title>Movie Recommendation System — MF · GMF · NeuMF</title>
<style>
  :root{
    --bg:#0f172a; --card:#111827; --muted:#94a3b8; --text:#e5e7eb; --accent:#22d3ee; --accent2:#a78bfa;
    --ok:#34d399; --warn:#fbbf24;
  }
  *{box-sizing:border-box}
  body{margin:0; font-family:Inter,system-ui,Segoe UI,Roboto,Helvetica,Arial,sans-serif;
       background:linear-gradient(180deg,#0b1220, var(--bg)); color:var(--text); line-height:1.55;}
  header{padding:48px 20px 16px; text-align:center}
  h1{font-size:34px; margin:0 0 8px; letter-spacing:.2px}
  h2{font-size:22px; margin:28px 0 10px; border-left:4px solid var(--accent); padding-left:10px}
  h3{font-size:18px; margin:20px 0 8px; color:#dbeafe}
  p,li{color:#e2e8f0}
  code,kbd{background:#0b1220; border:1px solid #1f2937; padding:2px 6px; border-radius:6px; color:#d1fae5}
  ...
  .card{background:rgba(17,24,39,.65); border:1px solid #1f2937; border-radius:14px; padding:18px}
  .muted{color:var(--muted)}
  .tag{display:inline-block; padding:4px 10px; border-radius:999px; background:#0b1220; border:1px solid #1f2937; margin-right:6px}
  .good{color:var(--ok)} .warn{color:var(--warn)}
  .tree{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; font-size:13px; white-space:pre}
  a{color:var(--accent)} a:hover{color:var(--accent2)}
  img.plot{width:100%; border-radius:12px; border:1px solid #1f2937; background:#0b1220}
  ...
  th{background:#0b1220; color:#c7d2fe}
  .toc a{display:block; color:#cbd5e1; padding:6px 0; text-decoration:none}
